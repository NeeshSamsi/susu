...
export default function LogoExplode({ isPlaying: _isPlaying }: ExperimentProps) {
  ...
  useEffect(() => {
    ...
    const rotations = shapes.map(() => Math.round(gsap.utils.random(-50, 50)))
